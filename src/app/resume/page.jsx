...
const Resume = () => {
  const about = {
    title: "About Me",
    description:
      "Hi! I’m Chinmay Ghadigaonkar, a Mumbai-based full-stack developer with a Bachelor’s in Engineering. With a strong foundation in HTML, CSS, JavaScript, React.js, and Express.js, I enjoy building interactive, responsive applications.  ",
    info: [
  ...
  const skillsComp = {
    title: "My Skills",
    description:
      "I'm skilled in frontend technologies like HTML, CSS, JavaScript, and React.js, and use Node.js with Express.js for backend development. I work with MongoDB for data management and have a solid grasp of Java and JavaScript for full-stack development. ",
    skillList: [
      ...
      { skillIcon: <PiFileSqlBold />, skillName: "SQL" },
                  ...
                  <ScrollArea className="h-[400px]">
                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                      {experience.map((item, index) => (
                        <li
                          key={index}
                          className="bg-[#232329] lg:pl-3 h-[184px] py-4 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1"
                        >
